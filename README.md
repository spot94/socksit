...
> **VPN-клиенты.** Шлюзы установленных VPN-клиентов (Cisco AnyConnect / Secure Client,
> FortiClient, встроенный VPN Windows) SocksIt находит сам и держит вне fake-ip: такой клиент
> ходит до своего шлюза мимо виртуальных адаптеров, и синтетический адрес просто не доехал бы.
> Ничего настраивать не нужно; что именно исключено — видно в «Диагностике» и в журнале.
