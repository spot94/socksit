...
- Журналы: `socksit logs` (runtime-лог службы) и `socksit logs --audit`
  ...
  Строки самой службы — в едином формате `ГГГГ-ММ-ДД ЧЧ:ММ:СС УРОВЕНЬ сообщение`
  (INFO/WARN/ERROR), удобном для grep; строки движка остаются в своём формате sing-box.
